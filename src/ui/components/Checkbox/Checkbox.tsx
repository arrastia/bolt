...
export const Checkbox = ({ children, isChecked }: { children: React.ReactNode; isChecked?: boolean }) => {
  return (
    <Fragment>
      ...
      <Styles.ToDoList>
        <Styles.ToDo>
          <Styles.Checkbox checked={isChecked} type="checkbox" />
          ...
          <Styles.Text onClick={event => event.preventDefault()}>{children}</Styles.Text>
        </Styles.ToDo>
      </Styles.ToDoList>
    </Fragment>
  );
